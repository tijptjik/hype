...
import type { FieldProps, ActionProps, EntityRouter, GetImageAPI, Refs } from '$lib/types';
...
let {
  ...
  fields,
  ...fieldProps
}: FieldProps & ActionProps & { InfoContent?: Component; Stats?: Component; refs?: Refs } = $props();
