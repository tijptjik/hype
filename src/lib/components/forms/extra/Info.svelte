  ...
  {#if isOpen}
    <Portal target="body">
      <div
        ...
        class="pointer-events-auto fixed left-1/2 top-1/2 z-9999 w-full max-w-160 -translate-x-1/2 -translate-y-1/2 rounded-xl border-4 {borderColor} bg-glass-300-solid p-12 shadow-2xl"
        role="dialog"
        aria-modal="true"
      >
