...
import ImageCredit from '$lib/components/common/ImageCredit.svelte';
...
<div
  ...
  <main class="relative flex h-full w-full flex-col rounded-b-2xl bg-base-300">
    {#if imageSets.activeImage}
      <!-- Navigation Arrows -->
      <Viewer image={imageSets.activeImage as GetImageAPI} isCrossfade={false} enableDropzone={true}>
