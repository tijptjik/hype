<script lang="ts">
    ...
    function generatePointsForKey(key: string) {
      ...
      const startPoints = generateNonOverlappingPoints(0, 100, NUMBER_OF_LINES, NO_OVERLAP_OFFSET);
...
<div 
  class="absolute top-[{HEADER_HEIGHT}px] inset-0 pointer-events-none z-0 w-[85%] mx-auto"
