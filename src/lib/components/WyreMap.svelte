<script lang="ts">
  ...
  onMount(async () => {
    ...
    const featureServiceUrl = 'https://services9.arcgis.com/5eO9hmsd8SoBl0Cj/ArcGIS/rest/services/GIS_SecondarySchoolsDesignatedAreas/FeatureServer';
    ...
    map.on('load', () => {
      ...
      const wmsLayer = 'http://inspire.misoportal.com/geoserver/wyre_forest_district_council_1845cpo/wms?request=getCapabilities';
