...
export function getOmnibarRootClasses(shouldFloatMobile: boolean): string {
  return cx(
    OMNIBAR_ROOT_SHARED_CLASSES,
    OMNIBAR_TRANSITION_CLASSES,
    shouldFloatMobile && OMNIBAR_ROOT_FLOATING_MOBILE_CLASSES,
...
export function getOmnibarSurfaceClasses(shouldFloatMobile: boolean): string {
  return cx(
    OMNIBAR_SURFACE_SHARED_CLASSES,
    OMNIBAR_TRANSITION_CLASSES,
    shouldFloatMobile && OMNIBAR_SURFACE_FLOATING_MOBILE_CLASSES,
...
function getOmnibarBarClasses(shouldFloatMobile: boolean): string {
  return cx(
    OMNIBAR_BAR_SHARED_CLASSES,
    OMNIBAR_TRANSITION_CLASSES,
    shouldFloatMobile && OMNIBAR_BAR_FLOATING_MOBILE_CLASSES,
    OMNIBAR_BAR_DESKTOP_CLASSES,
  )
}

export function getOmnibarNavBarClasses(shouldFloatMobile: boolean): string {
  return cx(
    getOmnibarBarClasses(shouldFloatMobile),
    'min-h-16 border-b-2 border-base-300',
    shouldFloatMobile && 'border-b-0',
    'w-120:border-b-0',
  )
}

export function getOmnibarSearchBarClasses(shouldFloatMobile: boolean): string {
  return cx(
    getOmnibarBarClasses(shouldFloatMobile),
...
export function getOmnibarResultsClasses(shouldFloatMobile: boolean): string {
  return cx(
