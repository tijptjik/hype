...
//   console.log('selectActiveImage', image);
//   console.log('selectActiveImage', image);
//   if (!image) return;
...
//           if (savedImage) {
//             console.log('imageLoadStates', imageSets.imageLoadStates);
//             console.log('setting saved image load state to loaded', savedImage);
//             imageSets.imageLoadStates[savedImage.id] = 'loaded';
//             imageSets.imagesLoaded[savedImage.id] = true;
...
//           );
//           setImageLoadState(updatedImage.id, 'loaded');
//           return updatedImage;
//         })
//         .catch((err) => {
...
//           setImageLoadState(savedImage.id, 'loaded');
//           return savedImage;
//         });
//     }
