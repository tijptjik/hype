ALTER TABLE `feature` RENAME COLUMN "formattedAddress" TO "displayAddress";--> statement-breakpoint
ALTER TABLE `feature` RENAME COLUMN "formattedAddressGen" TO "displayAddressGen";--> statement-breakpoint
ALTER TABLE `featureI18n` RENAME COLUMN "formattedAddress" TO "displayAddress";--> statement-breakpoint
ALTER TABLE `featureI18n` RENAME COLUMN "formattedAddressGen" TO "displayAddressGen";--> statement-breakpoint
...
CREATE TABLE `__new_organisation` (
	...
	`url` text,
	`image` text DEFAULT 'https://generative-placeholders.glitch.me/image?width=720&height=720&style=triangles&gap=71',
...
CREATE TABLE `__new_project` (
	...
	`image` text DEFAULT 'https://generative-placeholders.glitch.me/image?width=720&height=720&style=cellular-automata&cells=73',
